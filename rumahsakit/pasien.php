            ...
            <div class="col">
                <table class="table table-striped table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editpasien.php?edit=<?php echo $row['idPasien']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="koneksi.php?idPasien=<?php echo $row['idPasien']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    </tr>
                    <?php 
                        }
