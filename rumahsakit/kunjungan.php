...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <a href="tambahkunjungan.php" class="btn btn-primary btn-sm d-flex justify-content-center">Tambah Kunjungan</a>
            </div>
        </div>
        <!DOCTYPE html>
<html>
        ...
        <div class="row mt-3">
            <div class="col">
                <table class="table table-striped table-hover table-sm">
                    ...
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $row['idKunjungan']; ?></td>
                        <td><?php echo $row['idPasien']; ?></td>
                        <td><?php echo $row['idDokter']; ?></td>
                        <td><?php echo $row['tanggal']; ?></td>
                        <td><?php echo $row['keluhan']; ?></td>
                        <td>
                        <a href="editkunjungan.php?edit<?php echo $row['idKunjungan']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="koneksi.php?idKunjungan=<?php echo $row['idKunjungan']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
